...
public class MonsterKilledBoard {
    ...
    public void drawMonsterKilledBoard(GL10 gl, int monsterTexture, int[] numTextures, int monsterKilled) {

        monsterLogo.draw(gl, monsterTexture);
        firstDigit.draw(gl, numTextures[monsterKilled / 10]);
        secondDigit.draw(gl, numTextures[monsterKilled % 10]);
    }
}
